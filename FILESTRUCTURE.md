...
* C++ source files:
  * `include/rg-build-demo/rg-build-demo.hpp` is the main
    C++ header that declares the interface of your library.
  * `src/rg-build-demo.cpp` is the main file that implements this library.
  * `app/rg-build-demo_app.cpp` is an executable that uses the library.
    This can e.g. be used to provide a command line interface for your project.
  * `tests/rg-build-demo_t.cpp` contains the unit tests for the library.
